...
COPY --chown=mambauser web-app/data-intake-ms-planetary-computer.ipynb web-app/environment.yml .
...
CMD ["panel", "serve", "--port", "5006", "data-intake-ms-planetary-computer.ipynb", "--allow-websocket-origin=*"]